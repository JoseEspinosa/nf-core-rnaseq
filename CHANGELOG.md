...
## [[3.3-BOVREG-1](https://github.com/BovReg/nf-core-rnaseq/releases/tag/3.3)] - 2021-08-31

### Enhancements & fixes

* Added a subworkflow `subworkflows/local/quantify_stringtie.nf` to quantify transcript expression using the annotation generated by StringTie.

* Added a subworkflow `subworkflows/local/annotate_feelnc.nf` to annotate lncRNAs using the de-novo annotation generated by `StringTie`.
